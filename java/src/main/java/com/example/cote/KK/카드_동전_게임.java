...
public class 카드_동전_게임 {
    ...
    private static boolean countMatched(List<Integer> myCards, List<Integer> helpers, int stage, int n){
    ...
    private static int stage(List<Integer> myCards, Queue<Integer> drawOrigin, int coins, int stage, int n){
    ...
    public static void main(String... args) throws IOException{
        ...
        while(testCases > 0){
            ...
            int[] cards = Arrays.stream(rd.readLine().split(" "))
