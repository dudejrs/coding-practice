...
public class Command {
  ...
  private static class CompositeCommand {
    ...
    public static void main() {
      BankAccount account = new BankAccount();
      Command_ command =
          CompositeBankAccountCommand.of(
  ...
  private static class CommandQuerySeperation {
    ...
    public static void main() {
      ...
      creature.processCommand(
          new CreatureCommand(CreatureAbility.STRENGTH, CreatureCommand.Action.SET, 10));
      creature.processCommand(
          new CreatureCommand(CreatureAbility.AGILITY, CreatureCommand.Action.INCREASE_BY, 10));
