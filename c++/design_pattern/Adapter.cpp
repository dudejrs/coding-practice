...
struct VectorRectangle : VectorObject {
  ...
  vector<Line>::iterator begin() override { return ::begin(lines); };

  vector<Line>::iterator end() override { return ::end(lines); };
...
struct RendererAdapter : ClientRenderer {
  ...
  vector<Point> linesToPoints(VectorRectangle obj) { return RectToPoints(obj); }
...
struct ClientRenderer {
  void draw(VectorRectangle obj) { return; }
};
