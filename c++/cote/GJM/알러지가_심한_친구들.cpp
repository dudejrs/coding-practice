...
void initialize(fstream& fd, vector<int> eater[], vector<int> canEat[], int n, int m){
...
void search_badcase (int cur, vector<int>& edible, vector<int>eater[] , vector<int> canEat[], int n, int m, int chosen){
...
int solve_badcase(vector<int> eater[], vector<int> canEat[], const int n, const int m){
...
void search ( vector<int>& edible, vector<int>eater[] , vector<int> canEat[], int n, int m, int chosen){
...
int main(void){
	...
	while(test_cases > 0){
		...
		cout << solve_badcase(eater, canEat, n, m)<<"," << solve(eater,canEat, n,m)<< endl;
