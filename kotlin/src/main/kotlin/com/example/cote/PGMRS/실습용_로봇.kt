...
object 실습용_로봇 {
    ...
    class Robot(var position: Pair<Int, Int>, var direction: Direction) {
    ...
    fun Random.nextIntRange(a: Int, b: Int): Int = nextInt(b - a) + a
    ...
    fun main() {
        repeat(TEST_CASES) {
            ...
            val commands = List(n) { random.nextCommand() }
