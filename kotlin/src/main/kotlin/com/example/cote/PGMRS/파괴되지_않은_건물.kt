...
object 파괴되지_않은_건물 {
    ...
    fun solve(board: List<List<Int>>, skills: List<List<Int>>): Int {
        ...
        val skills_ =
            skills.map { Skill(it[0], it[1], it[2], it[3], it[4], it[5]) }
    ...
    fun main() {
        val reader =
            Paths.get(System.getProperty("user.dir") + "/data/파괴되지_않은_건물.txt")
                .run { Files.newBufferedReader(this) }
